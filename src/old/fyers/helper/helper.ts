...
import webSocketWrapper from "../socketWrapper/socketWrapper"
import tokenClass from "../token/tokenGeneration"
...
let orderUpdateInstance: any
let onSymbolUpdateInstance: any
...
const getSymbolData = async (ws: any, symbol: any, callback: any) => {
...
function onOrderUpdate(tokenValue: any, callback2: any, isUnsub = false) {
    ...
    orderUpdateInstance = webSocketWrapper(url, JSON.stringify(dataToSend), function (data: any) {
        callback2(data.data)
    })
}

async function onSymbolUpdate(symbol: any, tokenValue: any, callback2: any, isUnsub = false) {
